  ...
  const projects = [
    {
      ...
      websiteLink: "https://job-signature-eight.vercel.app/", // Will be updated later
    },
            ...
            <div className="flex space-x-4 md:space-x-6 pt-4 justify-center lg:justify-start">
              {[
                ...
                },
                {
                  ...
                  href: "https://drive.google.com/file/d/1LWbeJUAAFhQ4PVh-gP77kEMsAs2uCvnK/view?usp=sharing",
                  label: "Resume",
                },
              ].map((social, index) => (
                <a
